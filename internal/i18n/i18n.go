...
const (
	...
	CheckLocalReady               Key = "check.local_ready"
	CheckBuildReady               Key = "check.build_ready"
	CheckGitReady                 Key = "check.git_ready"
	CheckSSHReady                 Key = "check.ssh_ready"
	CheckRemoteExisting           Key = "check.remote_existing"
	...
	PromptProjectID               Key = "prompt.project_id"
	PromptProjectName             Key = "prompt.project_name"
	PromptEnvironmentID           Key = "prompt.environment_id"
	...
	FieldSSHServer                Key = "field.ssh_server"
	FieldRevision                 Key = "field.revision"

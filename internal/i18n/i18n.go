...
const (
	...
	HistoryShort                  Key = "history.short"
	HistoryTitle                  Key = "history.title"
	HistoryNotice                 Key = "history.notice"
	HistoryEmpty                  Key = "history.empty"
	HistoryEmptyTarget            Key = "history.empty_target"
	HistoryClean                  Key = "history.clean"
	HistoryDirty                  Key = "history.dirty"
	FlagHistoryLimit              Key = "history.flag.limit"
	...
	InvalidHistoryArguments       Key = "error.history_arguments"
	InvalidHistoryLimit           Key = "error.history_limit"
	HistoryReadFailed             Key = "error.history_read"
